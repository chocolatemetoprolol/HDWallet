Pod::Spec.new do |s|
  ...
  s.homepage         = 'https://github.com/chocolatemetoprolol/HDWallet.git'
  s.license          = { :type => 'MIT', :file => 'LICENSE.md' }
  s.author           = { 'impl' => 'pavlo.bojkoo@gmail.com' }
  s.source           = { :git => 'https://github.com/chocolatemetoprolol/HDWallet.git', :tag => s.version.to_s }
